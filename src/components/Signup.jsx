...
function Signup (){
    ...
    const[pwarning,setPwarning]=useState(false);
    const[uwarning,setUwarning]=useState(false);
    ...
    const active="flex justify-center w-full px-6 py-3 text-white bg-blue-500 rounded-lg md:w-auto md:mx-2 focus:outline-none";
    const deactive="flex justify-center w-full px-6 py-3 mt-4 text-blue-500 border border-blue-500 rounded-lg md:mt-0 md:w-auto md:mx-2 dark:border-blue-400 dark:text-blue-400 focus:outline-none";
    return(
        <>
            ...
            <div className="w-full">
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-3 md:flex md:items-center md:-mx-2">
                        <button className={usertype==='user'? active : deactive}
                        ...
                        <button className={usertype==='admin'? active : deactive}
                ...
                <p className={`${uwarning===true ?'':'hidden'} text-red-600`}>{message}</p>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="file" accept="image/*" className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" 
                    ...
                    <div>
                        ...
                        />
                        <p className={`${pwarning===true ?'':'hidden'} text-red-600`}>password and confirm password must be same</p>
                    </div>
